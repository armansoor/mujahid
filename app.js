...
function App() {
  ...
  var _useState19 = useState(false),
    ...
    fabMenuOpen = _useState20[0],
    setFabMenuOpen = _useState20[1];
  var _useState21 = useState(false),
    _useState22 = _slicedToArray(_useState21, 2),
    heroVideoInView = _useState22[0],
    setHeroVideoInView = _useState22[1];
  var heroVideoRef = React.useRef(null);
  ...
  var _useState25 = useState(function () {
    ...
    currentLanguage = _useState26[0],
    setCurrentLanguage = _useState26[1];
  ...
  useEffect(function () {
    var handleScrollForMiniPlayer = function handleScrollForMiniPlayer() {
      if (activeVideoId) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "fixed z-[100] transition-all duration-500 ".concat(isMiniPlayer ? 'bottom-24 right-6 w-80 shadow-2xl rounded-xl overflow-hidden border border-white/20' : 'inset-0 flex items-center justify-center p-4 sm:p-6')
    ...
    className: "absolute z-20 bg-black/50 hover:bg-red-600 text-white rounded-full flex items-center justify-center transition-colors border border-white/20 ".concat(isMiniPlayer ? 'top-2 right-2 w-6 h-6' : 'top-4 right-4 w-10 h-10')
  }, /*#__PURE__*/React.createElement("i", {
    className: "fa-solid fa-xmark ".concat(isMiniPlayer ? 'text-sm' : 'text-lg')
    ...
    className: "absolute top-2 left-2 z-20 w-6 h-6 bg-black/50 hover:bg-emerald-600 text-white rounded-full flex items-center justify-center transition-colors border border-white/20"
  }, /*#__PURE__*/React.createElement("i", {
  ...
  }), " Subscribe Channel"))), /*#__PURE__*/React.createElement("section", {
    id: "home",
    ...
    onClick: function onClick() {
      if (latestVideos.length > 0) setActiveVideoId(latestVideos[0].id);else scrollToSection({
    ...
    className: "fa-regular fa-circle-play text-xl"
  }), " Watch Latest Bayan"), /*#__PURE__*/React.createElement("a", {
  ...
  }), " Explore Channel")), latestVideos.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "max-w-4xl mx-auto w-full mb-12 relative group cursor-pointer",
    onClick: function onClick() {
      return setActiveVideoId(latestVideos[0].id);
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute -inset-1 bg-gradient-to-r from-amber-400 to-amber-600 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"
  }), /*#__PURE__*/React.createElement("div", {
    className: "relative bg-emerald-900 ring-1 ring-white/10 rounded-2xl overflow-hidden shadow-2xl"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-20 h-20 bg-red-600 rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(220,38,38,0.6)] transform group-hover:scale-110 transition-transform duration-300"
  }, /*#__PURE__*/React.createElement("i", {
    className: "fa-solid fa-play text-3xl text-white ml-2"
  }))), /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 to-transparent p-6 text-left"
  }, /*#__PURE__*/React.createElement("div", {
    className: "inline-block px-3 py-1 bg-red-600 text-white text-xs font-bold rounded mb-2"
  }, "LATEST"), /*#__PURE__*/React.createElement("h3", {
    className: "text-white font-bold text-xl md:text-2xl line-clamp-2 drop-shadow-lg"
    ...
    className: "fixed bottom-6 right-6 z-[90] flex flex-col items-end gap-3 notranslate"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col gap-3 transition-all duration-300 origin-bottom ".concat(fabMenuOpen ? 'scale-100 opacity-100' : 'scale-0 opacity-0 pointer-events-none')
  }, /*#__PURE__*/React.createElement("a", {
    href: "https://wa.me/919700440940",
    target: "_blank",
    rel: "noreferrer",
    className: "flex items-center gap-3 group"
  }, /*#__PURE__*/React.createElement("span", {
    className: "bg-white/90 text-emerald-950 px-3 py-1.5 rounded-lg text-sm font-bold shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap"
  }, "WhatsApp"), /*#__PURE__*/React.createElement("div", {
    className: "w-12 h-12 bg-green-500 hover:bg-green-400 text-white rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110"
  }, /*#__PURE__*/React.createElement("i", {
    ...
    className: "w-12 h-12 bg-amber-500 hover:bg-amber-400 text-white rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110"
  }, /*#__PURE__*/React.createElement("i", {
    className: "fa-solid fa-envelope text-xl"
  })))), /*#__PURE__*/React.createElement("button", {
    onClick: function onClick() {
      return setFabMenuOpen(!fabMenuOpen);
    },
    className: "w-14 h-14 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(16,185,129,0.4)] hover:shadow-[0_0_30px_rgba(16,185,129,0.6)] hover:scale-105 transition-all border border-white/20"
  }, /*#__PURE__*/React.createElement("i", {
    className: "fa-solid ".concat(fabMenuOpen ? 'fa-xmark' : 'fa-message', " text-2xl transition-transform ").concat(fabMenuOpen ? 'rotate-90' : 'rotate-0')
